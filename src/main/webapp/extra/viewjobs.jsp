	...
	<div class="container-xxl bg-white p-0" style="width: 10000px">
        ...
        <div class="container-xxl py-5">
        	<div style="display: flex; float: right;">
                    		<a href="deleteJob?job_Id=<%= rs.getInt(1) %>"> <i class='bx bxs-trash' style="font-size: 50px"></i> </a>
            </div>
            <div class="container">
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                        ...
                        try {
                			...
                			int count=0;
                			String selectQuery = "select * from recommend";
                		...
                		%>
                				...
                				<p><i class="fa fa-thumbs-up text-primary me-3"></i>အကြံပြုသင်တန်းများ</p> 
                		<%
                        ...
                        %>
                        <a href="recommend.jsp?job_Id=<%= rs.getInt(1) %>" class="btn btn-primary py-3 px-5 mt-3">အကြံပြုသင်တန်းများ ထပ်ထည့်ရန်</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container py-5">
                <div class="row g-5">
                    <div class="col-lg-6 col-md-6">
                        <h5 class="text-white mb-4">ကုမ္ပဏီ</h5>
                    ...
                    <div class="col-lg-6 col-md-6">
                        ...
                        <p class="mb-2"><i class="fa fa-phone-alt me-3"></i>+95 0978123456</p>
                        <p class="mb-2"><i class="fa fa-envelope me-3"></i>jobseeker@info.com</p>
