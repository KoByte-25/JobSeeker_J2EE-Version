...
<body>
    ...
    <div class="container-xxl bg-white p-0">
	                    	...
	                    	if(cusUserName==null)
	                    	{
	                    		%>
	                    			<div class="nav-item dropdown">
				                        <a href="#" id="textConfig" id="textConfig" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">အကောင့်ဝင်မည်</a>
        ...
        <!-- Category Start -->
        <div class="container-xxl py-5" id="here">
            <div class="container">
                    ...
                    <ul class="nav nav-pills d-inline-flex justify-content-center border-bottom mb-5">
                        <li class="nav-item">
                            <div class="d-flex align-items-center text-start mx-3 ms-0 pb-3" data-bs-toggle="pill">
                                <a href="index.jsp#here"><h6 class="mt-n1 mb-0">ဆိုင်များ</h6></a>
                            </div>
                        </li>
                        <li class="nav-item">
                            <div class="d-flex align-items-center text-start mx-3 me-0 pb-3" data-bs-toggle="pill">
                                <a href="bank.jsp#here"><h6 class="mt-n1 mb-0">ဘဏ်</h6></a>
                            </div>
                        </li>
                        <!-- <li class="nav-item">
                            <div class="d-flex align-items-center text-start mx-3 me-0 pb-3" data-bs-toggle="pill">
                        ...
                        <li class="nav-item">
                            <div class="d-flex align-items-center text-start mx-3 me-0 pb-3" data-bs-toggle="pill">
                                <a href="private.jsp#here"><h6 class="mt-n1 mb-0">ပုဂ္ဂလိကရုံးများ</h6></a>
                            </div>
                        </li>
                        <li class="nav-item">
                            <div class="d-flex align-items-center text-start mx-3 pb-3 active" data-bs-toggle="pill">
                                <a href="factory.jsp#here"><h6 class="mt-n1 mb-0">စက်ရုံများ</h6></a>
                            </div>
                        </li>
                    </ul>
