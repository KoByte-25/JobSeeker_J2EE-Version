                        ...
                        <div class="container">
                            <div class="row justify-content-start">
                                <div class="col-10 col-lg-8">
                                    <h1 class="display-3 text-white animated slideInDown mb-4">Job Seeker အကြောင်း </h1>
                                 </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                        <div class="row g-0 about-bg rounded overflow-hidden">
                            <div class="col-6 text-start">
                                <img class="img-fluid w-100" src="./Photo/background/background1.jpg">
                            </div>
                            <div class="col-6 text-start">
                                <img class="img-fluid" src="" style="width: 85%; margin-top: 15%;">
                            </div>
                            <div class="col-6 text-end">
                                <img class="img-fluid" src="" style="width: 85%;">
                            </div>
                            <div class="col-6 text-end">
                                <img class="img-fluid w-100" src="./Photo/background/background2.jpg">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s" style="width:550px">
                        <h2 class="mb-4">Job Seeker မှာ သင်နှင့်သင့်လျော်<br>သည့် အလုပ်ရှာဖွေလိုက်ပါ</h2>
                        <p class="mb-4">ယနေ့ခေတ်တွင် အင်တာနက်ကို အသုံးပြု၍ အလုပ်ရှာလိုသူတိုင်း အလုပ်ရှာကြသည်။ ဤပရောဂျက်သည် လစ်လပ်နေသောအလုပ်အား ဝဘ်ဆိုက်သို့ လျှောက်ထားရန်အတွက် အွန်လိုင်းရှာဖွေရေးပေါ်တယ်ကို တီထွင်ရန်ဖြစ်သည်။။</p>
						<h3>ရည်ရွယ်ချက်</h3>
                        <p><i class="fa fa-check text-primary me-3"></i> အလုပ်အကိုင်အခွင့်အလမ်းများ‌ပေါများခြင်း</p>
                        <p><i class="fa fa-check text-primary me-3"></i>အလုပ်ရှာဖွေရသည့် အချိန်၊ ငွေနှင့် လူအင်အားကို ချွေတာရန်</p>
                        <p><i class="fa fa-check text-primary me-3"></i>အလုပ်ရှာဖွေသူများ  မိမိနှင့်သင့်တော်သောအလုပ် အမြန်ရရှိစေခြင်း</p>
                        <p><i class="fa fa-check text-primary me-3"></i> အလုပ်ရှင်များမှလည်း လုပ်ငန်းနှင့်သင့်တော်သော လုပ်သားများ </p>
                        <p style="padding-left: 38px;">ရှာဖွေနိုင်ခြင်း</p>
