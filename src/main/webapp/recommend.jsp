...
<body>
	<div class="container-xxl bg-white p-0" style="width: 10000px">
		...
		%>
		<form method="post" action="addRecommend">
		<div class="card">
		<div class="div1" align="center">
			<h1 class="h1"> Fill Course Information </h1>
		</div>
		<table class="form-table">
			...
			<tr>
				...
				<td> <textarea name="add" rows="5" cols="50">  </textarea> </td>
			</tr>
			<tr>
				<td><label> Social Media Links </label> </td>
