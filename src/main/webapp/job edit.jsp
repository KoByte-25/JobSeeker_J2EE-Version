...
<meta content="width=device-width, initial-scale=1.0" name="viewport">
    ...
    <style>
        ...
        .form-table td input[type="submit"] {
            background: linear-gradient(-45deg, #fff, #00b474);
            color: black;
            border: none;
            border-radius: 4px;
            cursor: pointer;
...
try {
	...
	{
%>
<form method="post" enctype="multipart/form-data" action="jobEdit">
<div class="card">
<div class="div1" align="center">
	<h1 class="h1"> အချက်အလက်များ ပြင်ဆင်ပါ </h1>
</div>
<table class="form-table">
	<tr>
		<td> <label> အလုပ်နေရာအမျိုးအစား </label> </td>
		<td class="tdRight"> <input type="text" name="pos" value="<%= rs.getString(4) %>"/> </td>
	</tr>
	<tr>
		<td><label> ဆိုင်လိပ်စာ အပြည့်အစုံ </label>	</td>
		<td class="tdRight"> <textarea name="local" rows="5" cols="50"> <%= rs.getString(5) %> </textarea> </td>
	</tr>
	<tr>
		<td><label> မြို့နယ် </label> </td>
		<td class="tdRight"> <input type="text" name="town" value="<%= rs.getString(6) %>"/> </td>
	</tr>
	<tr>
		<td> <label> ခန့်မှန်းလစာ </label>  </td>
		<td class="tdRight"> <input type="text" name="salary" value="<%= rs.getString(8) %>"/> </td>
	</tr>
	<tr>
		<td> <label> လုပ်ငန်းလိုအပ်ချက်များ </label> </td>
		<td class="tdRight"> 
			...
			<textarea name="job requirements" rows="5" cols="50"> <%= rs.getString(9) %> </textarea> 
		</td>
	</tr>
	<tr>
		<td> <label> အလုပ်လုပ်ချိန် </label> </td> 
		<td class="tdRight"> <input type="text" name="working hours" value="<%= rs.getString(10) %>"/> </td>
	</tr>
	<tr>
		<td> <label>အလုပ်ဓာတ်ပုံ</label> </td> 
		<td class="tdRight"> <input type="file" name="photo"/> </td> 
	</tr>
	<tr>
		<td colspan="2">
			<input type="hidden" name="id" value="<%= rs.getString(1) %>" />
			<input type="submit" value="ပြင်မည်"/>
		</td>
	</tr>
</table>
</div>
